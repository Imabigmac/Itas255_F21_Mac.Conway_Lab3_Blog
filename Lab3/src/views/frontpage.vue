    ...
    <section class="bg-white py-8 px-16">
                    ...
                    <div class="flex items-center">
                        ...
                        >
                            <svg
                                ...
                                height="24"
                                viewBox="0 0 24 24"
                                class="fill-current hover:text-blue-700 transform transition-transform duration-500 ease-in-out"
        ...
        <div class="flex flex-wrap">
            <v-for
                ...
                v-bind:key="post.id"
                class="h-48 w-1/3 xl:w-1/4 p-6 flex flex-col hover:grow hover:shadow-lg border border-gray-300"
            >
                <a v-bind:href="'/posts/' + post.id" class="">
                    <div
                        class="w-48 h-20 text-blue-600 text-6xl font-bold mx-auto text-center"
                    >
                        {{ post.id }}
                    </div>
        ...
        <div class="flex w-full justify-center items-center gap-x-4">
            <div
                ...
                :key="page"
                @click="goToPage(page)"
                class="cursor-pointer mt-8 w-8 h-8 border-b border-black flex justify-center items-center hover:bg-blue-600 hover:text-white hover:cursor-pointer"
                :class="{
